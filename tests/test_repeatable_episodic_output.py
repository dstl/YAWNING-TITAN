...
@pytest.mark.parametrize("basic_2_agent_loop",
    [
        {"episodes":2,"entry_nodes":["0"],"high_value_nodes":["12"],"settings_file":"repeatable_threat_config.yaml","custom_settings":custom_random_setting},
        {"episodes":2,"entry_nodes":["0"],"high_value_nodes":["12"],"settings_file":"repeatable_threat_config.yaml"},
        {"episodes":random.randint(5,12),"entry_nodes":["0"],"high_value_nodes":["12"],"settings_file":"repeatable_threat_config.yaml"}
    ], indirect=True
)
