...
@pytest.mark.parametrize(
    ...
    [
        ...
        (0, 100, None, None, None, False, 101, False, "Value 101 is greater than the max property 100."),
        (0, 100, None, None, None, True, 100, False, "Value 100 is greater than the max property 99 (max=100 exclusive of this value)."),
        ...
        (0, 100, None, None, True, None, 0, False, "Value 0 is less than the min property 1 (min=0 exclusive of this value)."),
        ...
        (0, 100, None, None, None, False, "100", False, "Value 100 is of type <class 'str'>, not <class 'int'>."),
    ]
)
def test_int_properties_validation(min_val, max_val, allow_null, parity, exclusive_min,
                               exclusive_max, test_val, passed, fail_reason):
    """Tests validation of an integer by `IntProperties`."""
    int_properties = IntProperties(min_val=min_val, max_val=max_val,
                                   allow_null=allow_null, parity=parity,
