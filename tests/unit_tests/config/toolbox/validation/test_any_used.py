...
from yawning_titan.config.toolbox.groups.core import UseValueGroup
...
class Group(AnyUsedGroup):
    """Basic implementation of validation group :class: `~yawning_titan.config.toolbox.groups.validation.AnyUsedGroup`."""
...
def test_group() -> Group:
    """A test group with a mixture of :class: `~yawning_titan.config.toolbox.item_types.bool_item.BoolItem`'s and :class: `~yawning_titan.config.toolbox.groups.core.UseValueGroup`'s."""
    test_group = Group()
    return test_group
...
def test_bool_item_true(test_group: Group):
    """Test the validation when a :class: `~yawning_titan.config.toolbox.item_types.bool_item.BoolItem` is True."""
...
def test_use_value_used(test_group: Group):
    """Test the validation when a :class: `~yawning_titan.config.toolbox.groups.core.UseValueGroup` is used."""
...
def test_use_value_used_and_bool_item_true(test_group: Group):
    """Test the validation when a :class: `~yawning_titan.config.toolbox.groups.core.UseValueGroup` is used and :class: `~yawning_titan.config.toolbox.item_types.bool_item.BoolItem`."""
    test_group.c.use.value = True
