...
def test_input_validation_1(generate_generic_env_test_run):
...
def test_input_validation_2(generate_generic_env_test_run):
    """Test that incorrect/broken configuration files raise errors."""
    with pytest.raises(ValueError):
        generate_generic_env_test_run(
...
def test_input_validation_3(generate_generic_env_test_run):
    """Test that incorrect/broken configuration files raise errors."""
    with pytest.raises(ValueError):
        generate_generic_env_test_run(
...
def test_input_validation_4(generate_generic_env_test_run):
    """Test that incorrect/broken configuration files raise errors."""
...
def test_input_validation_5(generate_generic_env_test_run):
    """Test that incorrect/broken configuration files raise errors."""
    with pytest.warns(UserWarning):
