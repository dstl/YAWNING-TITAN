...
class Network(nx.Graph):
    ...
    def set_from_dict(self, config_dict:dict, reset_edges:bool=False, reset_nodes:bool=False):
        ...
        :param reset_edges: Whether to remove existing edges
        :param reset_nodes: Whether to remove existing nodes
        """
        if "_doc_metadata" in config_dict:
            config_dict["_doc_metadata"] = DocMetadata(**config_dict.pop("_doc_metadata"))
        ...
        if "nodes" in config_dict:
            self.add_nodes_from_dict(nodes_dict=config_dict.pop("nodes"),remove_existing=reset_nodes)

        if "edges" in config_dict:
            self.add_edges_from_dict(edges_dict=config_dict.pop("edges"),remove_existing=reset_edges)
