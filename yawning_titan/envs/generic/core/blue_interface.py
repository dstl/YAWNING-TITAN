...
class BlueInterface(BlueActionSet):
    ...
    def __init__(self, network_interface: NetworkInterface):
        ...
        if self.network_interface.settings.blue.blue_reduce_vuln_action:
            # Checks if the action is enabled in the settings file
            self.action_dict[action_number] = self.reduce_node_vulnerability
            action_number += 1
        if self.network_interface.settings.blue.blue_restore_node_action:
            self.action_dict[action_number] = self.restore_node
            action_number += 1
        if self.network_interface.settings.blue.blue_make_node_safe_action:
            self.action_dict[action_number] = self.make_safe_node
            action_number += 1
        if self.network_interface.settings.blue.blue_isolate_action:
            self.action_dict[action_number] = self.isolate_node
            action_number += 1
        if self.network_interface.settings.blue.blue_reconnect_action:
        ...
        # separately
        if self.network_interface.settings.blue.blue_deceptive_action:
        ...
        if self.network_interface.settings.blue.blue_scan_action:
        ...
        if self.network_interface.settings.blue.blue_do_nothing_action:
            # does nothing
