...
class BlueInterface(BlueActionSet):
    ...
    def __init__(self, network_interface: NetworkInterface):
        ...
        # separately
        if self.network_interface.blue_deceptive_action:
        ...
        if self.network_interface.blue_scan_action:
        ...
        if self.network_interface.blue_do_nothing_action:
            # does nothing
