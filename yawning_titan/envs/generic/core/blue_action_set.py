...
class BlueActionSet:
    ...
    def reduce_node_vulnerability(self, node: str) -> Tuple[str, str]:
        ...
        if new < self.network_interface.game_mode.game_rules.node_vulnerability_lower_bound:
            new = self.network_interface.game_mode.game_rules.node_vulnerability_lower_bound
    ...
    def make_safe_node(self, node: str) -> Tuple[str, str]:
        ...
        if self.network_interface.game_mode.blue.making_node_safe_modifies_vulnerability:
            ...
            if new > self.network_interface.game_mode.game_rules.node_vulnerability_upper_bound:
                new = self.network_interface.game_mode.game_rules.node_vulnerability_upper_bound
            elif new > self.network_interface.game_mode.game_rules.node_vulnerability_lower_bound:
                new = self.network_interface.game_mode.game_rules.node_vulnerability_lower_bound
            self.network_interface.update_single_node_vulnerability(node, new)

        elif self.network_interface.game_mode.blue.making_node_safe_gives_random_vulnerability:
            # Gives the node a new random vulnerability
            upper = self.network_interface.game_mode.game_rules.node_vulnerability_upper_bound
            lower = self.network_interface.game_mode.game_rules.node_vulnerability_lower_bound
