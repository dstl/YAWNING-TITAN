...
_YT_USER_DIRS: Final[
    Union[Path, WindowsPath, PosixPath]] = Path.home() / "yawning_titan"
...
DB_DIR: Final[Union[
    Path, WindowsPath, PosixPath]] = _YT_PLATFORM_DIRS.user_data_path / "db"
"""The path to the app db directory as an instance of `Path` or `PosixPath`, depending on the OS."""

APP_IMAGES_DIR: Final[
    Union[
        Path, WindowsPath, PosixPath]] = _YT_PLATFORM_DIRS.user_data_path / "app_images"
"""The path to the app images directory as an instance of `Path` or `PosixPath`, depending on the OS."""

NOTEBOOKS_DIR: Final[
    Union[Path, WindowsPath, PosixPath]] = _YT_USER_DIRS / "notebooks"
"""
...
GAME_MODES_DIR: Final[
    Union[Path, WindowsPath, PosixPath]] = _YT_USER_DIRS / "game_modes"
"""
...
IMAGES_DIR: Final[
    Union[Path, WindowsPath, PosixPath]] = _YT_USER_DIRS / "images"
"""
...
VIDEOS_DIR: Final[
    Union[Path, WindowsPath, PosixPath]] = _YT_USER_DIRS / "videos"
"""
...
AGENTS_DIR: Final[
    Union[Path, WindowsPath, PosixPath]] = _YT_USER_DIRS / "agents"
"""
...
AGENTS_LOGS_DIR: Final[
    Union[Path, WindowsPath, PosixPath]] = _YT_USER_DIRS / "agents" / "logs"
"""
...
PPO_TENSORBOARD_LOGS_DIR: Final[
    Union[
        Path, WindowsPath, PosixPath]] = _YT_USER_DIRS / "agents" / "logs" / "tensorboard"
"""
