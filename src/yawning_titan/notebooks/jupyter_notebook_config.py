...
c.NotebookApp.tornado_settings = {
    "headers": {
        "Content-Security-Policy": "frame-ancestors self http://127.0.0.1:8000/jupyter/"
    },
...
#  Choices: any of ['sha384', 'sha3_384', 'sha3_256', 'sha256', 'sha224', 'sha512', 'blake2b', 'blake2s', 'sha3_224', 'md5', 'sha1', 'sha3_512']
#  Default: 'sha256'
